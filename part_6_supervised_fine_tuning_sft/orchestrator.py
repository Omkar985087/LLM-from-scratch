...
#
#   part_6_supervised_fine_tuning_sft/
...
#       test_masking.py
#
# Run from inside `part_6_supervised_fine_tuning_sft/`:
#   cd part_6_supervised_fine_tuning_sft
...
### FILE: part_6_supervised_fine_tuning_sft/orchestrator.py
...
if __name__ == "__main__":
    ...
    # 2) optional demo
    if args.demo:
        # --ckpt ../part_4_scaling_up/runs/part4-demo/model_last.pt # assumes Part 4 demo has been run
        run("python train_sft.py --data huggingface --ckpt ../part_4_scaling_up/runs/part4-demo/model_last.pt --out runs/sft-demo --steps 300 --batch_size 8 --block_size 256 --n_layer 2 --n_head 2 --n_embd 128")
