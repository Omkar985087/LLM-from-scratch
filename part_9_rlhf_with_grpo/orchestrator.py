...
#
# Run from inside `part_9_rlhf_with_grpo/`:
#   cd part_9_rlhf_with_grpo
...
if __name__ == "__main__":
    ...
    if args.demo:
        run("python train_grpo.py --group_size 4 --policy_ckpt ../part_6_supervised_fine_tuning_sft/runs/sft-demo/model_last.pt --reward_ckpt ../part_7_reward_modeling/runs/rm-demo/model_last.pt --steps 200 --batch_prompts 4 --resp_len 128 --bpe_dir ../part_4_scaling_up/runs/part4-demo/tokenizer")
        run("python eval_ppo.py --policy_ckpt runs/grpo-demo/model_last.pt --reward_ckpt ../part_7_reward_modeling/runs/rm-demo/model_last.pt --split train[:24] --bpe_dir ../part_4_scaling_up/runs/part4-demo/tokenizer")
