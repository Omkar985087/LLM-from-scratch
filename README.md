...
## [Part 1 — Core Transformer Architecture](part_1_core_transformer_architecture)
...
## [Part 2 — Training a Tiny LLM](part_2_training_a_tiny_llm)
...
## [Part 3 — Modernizing the Architecture](part_3_modernizing_the_architecture)
...
## [Part 4 — Scaling Up](part_4_scaling_up)
...
## [Part 5 — Mixture-of-Experts (MoE)](part_5_mixture_of_experts_moe)
...
## [Part 6 — Supervised Fine-Tuning (SFT)](part_6_supervised_fine_tuning_sft)
...
## [Part 7 — Reward Modeling](part_7_reward_modeling)
...
## [Part 8 — RLHF with PPO](part_8_rlhf_with_ppo)
...
## [Part 9 — RLHF with GRPO](part_9_rlhf_with_grpo)
